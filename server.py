...
app = Flask(__name__)       # __name__ es el nombre del archivo
                            # su finalidad es que flask sepa donde esta ubicado
...
# usa un puerto diferente al 8080
    app.run(port= 5000 , debug=True) # debug=True para que se actualice automaticamente. En mi caso, un puerto disponible es el 5000